  ...
  return (
    ...
    >
      <div className="w-full">
        <div className="flex flex-col xl:flex-row justify-between items-center gap-[30px]">
          {/* Formulaire de contact */}
          <div className="order-2 xl:order-none w-full xl:max-w-lg">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <Textarea className="h-[200px]" placeholder="Votre message" />
