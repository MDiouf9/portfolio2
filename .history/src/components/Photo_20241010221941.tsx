    ...
    <div className='w-full h-full relative flex justify-center items-center'>
      ...
      >
        ...
        <motion.div 
          initial={{ opacity: 0 }} 
          animate={{ opacity: 1, transition: { delay: 0.2, duration: 0.4, ease: "easeIn" } }}
          className='w-[150px] h-[150px] xl:w-[350px] xl:h-[350px] mix-blend-lighten relative'
        >
        ...
        {/* Cercle animé */}
        <motion.svg 
          className="absolute top-0 left-0 w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] md:w-[200px] md:h-[200px] lg:w-[300px] lg:h-[300px] xl:w-[350px] xl:h-[350px]" 
          fill="transparent" 
          viewBox="0 0 506 506" 
